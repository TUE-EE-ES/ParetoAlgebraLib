...
(1) Download the file "cudd231.zip" to your computer
    from http://web.cecs.pdx.edu/~alanmi/research/soft/ports/cudd231.zip
    The original version of CUDD is distributed and supported by
    Fabio Somenzi <Fabio@Colorado.EDU>, http://vlsi.colorado.edu/~fabio/ and the
    Windows prot is distributed and supported by Alan Mishchenko, http://www.eecs.berkeley.edu/~alanmi/
...
(3) Open "cudd.dsw" in Microsoft Visual Studio 2013 (File -> Open Solution...) and let it do its updates and conversions
...
(5) Compile the release version of the library by selecting
    the appropriate configuration ("Release") from the drop-down list at the top of the window.

(6) Close Visual Studio

(5) Open "Pareto_Calculator.sln" in Microsoft Visual Studio (File -> Open Solution...)

(6) Compile release versions of the project by selecting
    the appropriate configuration ("Release") from the drop-down list at the top of the window.


This project also uses the Windows port of modified GBDD package which its orginial version is distributed
by Marcus Nilsson, http://www.regularmodelchecking.com/software/
who bears no responsibility for this port.
Applications developed and tested under UNIX GBDD, can be compiled and used on Windows
with the Windows and modified release of GBDD. This version of GBDD hase some extera features for supporting
