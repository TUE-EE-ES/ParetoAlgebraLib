...
//My 
Space::Bdd CuddSpace::bdd_Xor(Bdd p,Bdd q)
{
	return (Bdd)Cudd_bddXor(manager, (DdNode*)p, (DdNode*)q);
}

Space::Bdd CuddSpace::bdd_Xnor(Bdd p,Bdd q)
{
	return (Bdd)Cudd_bddXnor(manager, (DdNode*)p, (DdNode*)q);
}

int CuddSpace::bdd_size(Bdd p)
{
	return Cudd_DagSize((DdNode*)p);
}
