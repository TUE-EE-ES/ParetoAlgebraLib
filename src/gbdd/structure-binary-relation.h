...
namespace gbdd
{
	...
	public:
		...
		StructureBinaryView(const Domain& domain1, const Domain& domain2, const StructureT& bb) : RelationT((Domains) domain1 * (Domains) domain2, bb) {}
		StructureBinaryView(const Domain& domain1, const Domain& domain2, const StructureBinaryView& s) : RelationT((Domains) domain1 * (Domains) domain2, s) {}
		...
		static StructureBinaryView cross_product(const Domain& domain1,
							...
							const SetT& set2)
			{
				...
				return StructureRelation::cross_product((Domains) domain1 * (Domains) domain2, sets);
			}

		SetT range() const
			{
				return this->project_on(0);
			}

		SetT image() const
			{
				return this->project_on(1);
			}
